...
const textures: THREE.Texture[] = imageUrls.map((url) => textureLoader.load(url));
const sphereGeometry: THREE.SphereGeometry = new THREE.SphereGeometry(1, 28, 28);

const spheres: { scale: number }[] = [...Array(30)].map(() => ({
...
const TechStackDesktop = () => {
  ...
  return (
    <div className="techstackDesktop flex justify-center items-center p-4">
      <h2> Stack técnico</h2>
